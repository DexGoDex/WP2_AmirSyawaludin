<section>
    ...
    <p allign="justify">Pada pengertian codeigniter di atas
    ...
    <ol type="a">
        <li>Model</li>
        <p allign="justify">Model adalah kelas yang merepresentasikan atau
        ...
        <p allign="justify">Sebagai catatan, Semua model harus disimpan di
            dalam folder application\models</p>
        <li>View</li>
        <p allign="justify">View merupakan bagian yang menangani halaman user
        ...
        <li>Controller</li>
        <p allign="justify">Controller merupakan kumpulan intruksi aksi yang
